...
def getconnect():
    return p.connect(host="localhost",user="root",password="",database="komal3")
...
def insertdata():
    ...
    sql="insert into komal3 values(%s,%s,%s,%s);"
    cr.execute(sql, t)
...
def deletedata():
    ...
    sql="delete from komal3 where id=%s;"
...
def showdata():
    ...
    sql="select * from komal3 where id=%s;"
    cr.execute(sql, i_d)
...
def updatedata(uemp):
    ...
    if uemp == "1":
        ...
        t = (name, i_d)
        sql = "update komal3 set name=%s where id = %s;"
        cr.execute(sql,t)
        print("Data updated")
        ...
        t = (email, i_d)
        sql = "update komal3 set email=%s where id = %s;"
        cr.execute(sql,t)
        print("Data updated")
        ...
        t = (place, i_d)
        sql = "update komal3 set palce=%s where id = %s;"
        cr.execute(sql,t)
        print("Data updated")
        ...
        t = (nid, i_d)
        sql = "update komal3 set id=%s where id = %s;"
        cr.execute(sql,t)
        print("Data updated")
