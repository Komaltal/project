...
def getconnect():
    return p.connect(host="localhost", user="root", password="", database="komal1")
...
def updatedata(t):
    db=getconnect()
    cr=db.cursor()
    sql="update emp2 set Name=%s, Department=%s, Salary=%s, Location=%s where Id=%s"
    cr.execute(sql,t)
...
def updateNameByID(t):
    db=getconnect()
    cr=db.cursor()
    sql="update emp2 set Name=%s where Id=%s"
    cr.execute(sql,t)
    print("Data Updated Successfully")
    db.commit()
    db.close()
...
def updateDeptByID(t):
    db=getconnect()
    cr=db.cursor()
    sql="update emp2 set Department=%s where Id=%s"
    cr.execute(sql,t)
    print("Data Updated Successfully")
    db.commit()
    db.close()
...
def updateLocByID(t):
    db=getconnect()
    cr=db.cursor()
    sql="update emp2 set Location=%s where Id=%s"
    cr.execute(sql,t)
    print("Data Updated Successfully")
    db.commit()
    db.close()
...
def deleteName(t):
    db=getconnect()
    cr=db.cursor()
    sql="update emp2 set Name=Null where Id=%s"
    cr.execute(sql,t)
    print("Data Updated Successfully")
    db.commit()
    db.close()
...
def deleteDept(t):
    db=getconnect()
    cr=db.cursor()
    sql="update emp2 set Department=Null where Id=%s"
    cr.execute(sql,t)
    print("Data Updated Successfully")
    db.commit()
    db.close()
...
def deleteSal(t):
    db=getconnect()
    cr=db.cursor()
    sql="update emp2 set Salary=Null where Id=%s"
    cr.execute(sql,t)
    print("Data Updated Successfully")
    db.commit()
    db.close()
...
def deleteLoc(t):
    db=getconnect()
    cr=db.cursor()
    sql="update emp2 set Location=Null where Id=%s"
    cr.execute(sql,t)
    print("Data Updated Successfully")
    db.commit()
    db.close()
...
def fetchName(t):
    db=getconnect()
    cr=db.cursor()
    sql ="select Name from emp2 where ID=%s"
    cr.execute(sql)
    data=cr.fetchall()
    for d in data:
        print (f"{d[1]:^3}")
...
def fetchDept(t):
    db=getconnect()
    cr=db.cursor()
    sql ="select Department from emp2 where ID=%s"
    cr.execute(sql)
    data=cr.fetchall()
    for d in data:
        print (f"{d[2]:^20}")
...
def fetchLoc(t):
    db=getconnect()
    cr=db.cursor()
    sql ="select Location from emp2 where ID=%s"
    cr.execute(sql)
    data=cr.fetchall()
    for d in data:
        print (f"{d[4]:^20}")
